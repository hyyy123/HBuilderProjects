...
//app="F3AB63BBA6DD3BF87A3D86DB824855652BC0A10810F8D70D6170386EE5C75906";
...
//=============================================================个人中心================================================================
function getInfoSelf(func) { 
    var url =http+ "/tools/api_mms.ashx?action=get_self_info&token="+app;
//  console.log(url)
     getAjax(url, false, false, function (data) {
        if (func != undefined) {
            func(data);
...
//=============================================================班级列表人员================================================================
function getClassAllList(func) { 
    var url =http+ "/tools/ManagerClass.ashx?action=get_list&token="+app;
//  console.log(url)
     getAjax(url, false, false, function (data) {
        if (func != undefined) {
            func(data);
...
function getStudentAllList(class_code,func) { 
    var url =http+ "/tools/ManagerStudent.ashx?action=get_list_by_class&token="+app+"&class_code="+class_code;
//  console.log(url)
     getAjax(url, false, false, function (data) {
        if (func != undefined) {
            func(data);
...
function getTypesList(p, ps, stat, func) {
    var url = http+ "/tools/api_rms.ashx?act=get_type_list&p=" + p + "&ps=" + ps + "&stat=" + ps+"&token="+app;
    //console.log(url);
