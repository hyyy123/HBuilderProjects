					...
					if($(this).val().match("日")){
						date=[ ]
						 date = ['0:00','1:00','2:00','3:00','4:00','5:00','6:00','7:00','8:00','9:00','10:00','11:00','12:00','13:00','14:00','15:00','16:00',
							'17:00','18:00','19:00','20:00','21:00','22:00','23:00','24:00'];
//							data1=[120, 132, 191,132, 191,132, 191,132, 191,132, 191,132, 191,132, 191, "-", "-", "-", "-","-", "-", "-", "-","-", "-", "-", "-","-", "-", "-", "-","-", "-", "-"];
//							 data2=["-","-", "-", "-", "-","-", "-", "-", "-" ,"-", "-", "-", "-","-", 191, 234, 190, 132, 191,132, 191,132, 191,132,191,]
							//数据视图刷新
							 		plus( )
					}else if($(this).val().match("周")){
						 date=[ ]
						 date = ['周一','周二','周三','周四','周五','周六','周日'];
						data1=[120, 132,101,100,"-","-", "-","-", "-"];
						 data2=["-", "-", "-",  100,101,191,132, 191,]
							//数据视图刷新
						 		plus( )
					}
				    ...
				    tooltip : {
				        show: true, // 是否显示提示框组件 
				            ...
				            return "<p style='padding:0px 5px;color:#000;'>"+param[0].name +" </p>"
						         + "<p style='padding:0px 6px;padding-right:50px;;color:#000;font-size:14px;line-height:20px;margin-top:30px;'>"+arr+ ' </br>' + "<span style='color:#EB8E06'>"+param[0].value+"&nbspkw·h</span> </p>"
                     		  },
