...
//			 	if($("#main1").width()!=$("#main1").children("div:first").width()){
//			 		alert(1)
//			 	}
//			 })
			 }
				    ...
				    tooltip : {
				        show: true, // 是否显示提示框组件 
				            ...
				            return "<p style='padding:0px 5px;color:#000;'>"+param[0].name +" </p>"
						         + "<p style='padding:0px 6px;padding-right:50px;;color:#000;font-size:14px;line-height:30px;margin-top:20px;'>"+"流量"+ ' </br>' + "<span style='color:#EB8E06'>"+param[0].value+"&nbspkwh</span> </p>"
                        },
