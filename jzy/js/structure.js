var category_data = [{
	...
	data: [{
		...
		"childrens": [{
			...
			{
				"id": 3,
				"icon": "../img/icon/e-air-conditioner.png",
				"name": "动力用电",
				"value": "----",
				"unit": "kwh",
				"pid": 1,
				...
				"childrens": [{
					...
					{
						"id": 12,
						"icon": "../img/icon/e-cooling-wate.png",
						"name": "真空吸引",
						"value": "----",
						"unit": "kwh",
						"pid": 4,
					...
					{
						"id": 13,
						"icon": "../img/icon/e-pump-auxiliary.png",
						"name": "主楼动力",
						"value": "----",
						"unit": "kwh",
						"pid": 4,
			...
			},
			{
				...
				"childrens": [{
					...
					{
						"id": 20,
						"icon": "../img/icon/e-ventilator.png",
						"name": "应急照明",
						"value": "----",
						"unit": "kwh",
						"pid": 3,
...
function setData() {
//alert(JSON.stringify(category_data.length))
	for(var i = 0; i < category_data.length; i++) {
//		alert(category_data[i].id)
...
//alert(jQuery(".jqrgchart-container").html());
